        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameTypeRoom = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisForm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegisForm_Guest_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guest",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegisForm_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Booking_RegisForm_RegisFormId",
                        column: x => x.RegisFormId,
                        principalTable: "RegisForm",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "RegisFormService",
                columns: table => new
                {
                    RegisFormServicesId = table.Column<int>(type: "int", nullable: false),
                    ServiceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisFormService", x => new { x.RegisFormServicesId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_RegisFormService_RegisForm_RegisFormServicesId",
                        column: x => x.RegisFormServicesId,
                        principalTable: "RegisForm",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegisFormService_Service_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingRegisForm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingRegisForm_Booking_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Booking",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingRegisForm_RegisForm_RegisFormId",
                        column: x => x.RegisFormId,
                        principalTable: "RegisForm",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingService_Invoice_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingRegisForm_BookingId",
                table: "BookingRegisForm",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingRegisForm_RegisFormId",
                table: "BookingRegisForm",
                column: "RegisFormId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingService_InvoiceId",
                table: "BookingService",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisForm_GuestId",
                table: "RegisForm",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_RegisForm_StaffId",
                table: "RegisForm",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_RegisFormService_ServiceId",
                table: "RegisFormService",
                column: "ServiceId");
