...
{
    public abstract class HotelMarriotterWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HotelMarriotterWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HotelMarriotterWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HotelMarriotterDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HotelMarriotterDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HotelMarriotterDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HotelMarriotterDbContext, Task<T>> func)
        {
            T result;
